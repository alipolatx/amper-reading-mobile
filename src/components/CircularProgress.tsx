...
const CircularProgress: React.FC<CircularProgressProps> = ({
  ...
  const offPercentage = totalReadings > 0 ? (offCount / totalReadings) * 100 : 0;
  const minPercentage = totalReadings > 0 ? (minCount / totalReadings) * 100 : 0;
  const midPercentage = totalReadings > 0 ? (midCount / totalReadings) * 100 : 0;
  const maxPercentage = totalReadings > 0 ? (maxCount / totalReadings) * 100 : 0;
